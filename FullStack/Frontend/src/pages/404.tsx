  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel='icon' href='/logoerror.svg' />
      </Head>
        ...
        <header className='mt-9 px-5 md:px-16'>
          <div className='flex items-center justify-between w-full max-w-[1180px] mx-auto'>
            ...
            <div className='hidden md:flex space-x-4'>
              {[
                { text: 'Error ', url: 'https://kde.ru/kb/info' },
                { text: 'Support', url: 'https://t.me/sqlinked' },
                { text: ' Error', url: 'https://kde.ru/kb/info' }
              ].map(({ text, url }) => (
                <a
                  key={text}
                ...
                >
                  <button className='bg-transparent border border-[#9A9A9A] rounded-lg h-9 w-24 transition duration-300 ease-in-out hover:bg-gradient-to-r from-[#6DDCFF] to-[#7F60F9] hover:border-none'>
